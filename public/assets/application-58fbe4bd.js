...
function updateSeason() {
  const season = ["spring", "summer", "autumn", "winter"].find(
    (s) => document.body.classList.contains(s)
  );
  if (!season) {
    console.log("\u274C No season class found on body");
    return;
  }
  console.log(`\u{1F338} Season active: ${season}`);
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-2cc1dc6b.js.map
