...
NG_WORDS ||= %w[
  ...
  過激表現 暴言中傷 迷惑行為 不快 嫌気 悪質 不愉快 危険行為 危険物 犯罪行為 卑猥表現 侮辱行為 卑劣行為 暴力表現 脅迫行為 性的表現 下品表現 卑猥行為
  過激言動 暴力言動 脅迫言動 差別言動 侮辱言動 中傷言動 嫌がらせ言動 不適切言動 不快発言 不謹慎 不謹慎表現 性的嫌がらせ 性的暴力 性的差別 下品発言 下ネタ発言 卑猥発言
  過激表現発言 暴力発言 脅迫発言 差別発言 嘲笑発言 虐待 虐殺 暴動 テロ 違法薬物 犯罪組織 暴力団 麻薬取引 強盗 殺人 監禁 拉致 拷問 エロ タヒ
