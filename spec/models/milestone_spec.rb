...
RSpec.describe Milestone, type: :model do
  ...
  it '未来宣言箱の投稿に対して、タイトルが設定されていれば Milestone は有効である' do
    post_record = Post.create!(user: user, body: '未来投稿', post_type: :future, deadline: deadline)
  ...
  it '未来宣言箱以外の投稿には Milestone を設定できない' do
    post_record = Post.create!(user: user, body: '整理投稿', post_type: :organize, mood: :calm)
